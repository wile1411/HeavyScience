...
namespace HeavyScience
{
    internal class Log
    {
        ...
        private static string prefix = "[HeavyScience] ";
        ...
        {
            UnityEngine.Debug.LogWarning(prefix + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
            UnityEngine.Debug.LogError(prefix + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
#if DEBUG
            UnityEngine.Debug.Log(prefix + new StackFrame(1, true).GetMethod().Name + ": " + message);
#endif
        }
